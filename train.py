...
def train(hyp, opt, device, tb_writer=None):
    ...
    if pretrained:
        ...
        state_dict = intersect_dicts(ckpt, model.state_dict(), exclude=exclude)  # intersect
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='../weights/yolov4-csp.pth', help='initial weights path')
    ...
    parser.add_argument('--seed', type=int, default=1, help='pytorch random seed')
