...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='yolov4-p7.pth', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='yolov4-p7.yaml', help='model.yaml path')
